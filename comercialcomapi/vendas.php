    ...
    <div class="table-responsive">
        <table class="table table-striped">
            ...
            <tbody>
                ...
                $query = "SELECT v.id, p.nome AS produto, v.quantidade, v.cliente, v.data_venda, p.preco 
                          FROM vendas v 
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    $valortotal = $row['quantidade'] * $row['preco'];
                    ...
                    echo "<td>".date('d/m/Y H:i:s', strtotime($row['data_venda']))."</td>";
                    echo "<td>
